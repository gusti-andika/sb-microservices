...
public class ProductCompositeServiceApplication {
	...
	public Docket apiDocumentation() {
		...
		/*
		 * @Autowired HealthAggregator healthAggregator;
		 * 
		 * @Autowired ProductCompositeIntegration integration;
		 * 
		 * @Bean ReactiveHealthIndicator coreServices() {
		 * 
		 ...
		 * integration.getRecommendationHealth()); registry.register("review", () ->
